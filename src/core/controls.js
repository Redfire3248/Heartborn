...
export const ACTIONS = [
  ...
  { id: 'jobs', label: 'People', group: 'Screens', def: 'j' },
  { id: 'court', label: 'Court', group: 'Screens', def: 'c' },
  { id: 'deeds', label: 'Powers', group: 'Screens', def: 'k' },
  { id: 'log', label: 'Log', group: 'Screens', def: 'l' },
