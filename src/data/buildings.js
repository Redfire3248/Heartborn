...
export const BUILDINGS = {
  ...
  enchanting_table: { name: 'Enchanting Table', era: 0, size: 1, cost: { stone: 80, obsidian: 12, gems: 40, gold: 300 }, work: 14, sprite: 'buildings/enchanting_table', craftStation: true, desc: 'Stand next to it and press E to enchant weapons, armour and tools with gems and gold.' },
  market_stall:    { name: 'Market Stall',     era: 0, size: 1, cost: { wood: 40, stone: 20, gold: 60 },     work: 10, sprite: 'buildings/trade_stall', craftStation: true, desc: 'Stand next to it and press E: three new offers every day, and it buys your ores and materials for gold.' },
