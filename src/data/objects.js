...
export const CREATURES = {
  ...
  ashen_knight:  { sprite: 'characters/ashen_knight', fallback: { sprite: 'characters/warrior', tint: '#3a2e44' }, size: 1.8, hp: 1200, speed: 36, hostile: true, damage: 42, armor: 0.45, boss: true, elden: true },
