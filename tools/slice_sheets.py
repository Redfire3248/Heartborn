...
DEFAULT_FILES = {
    ...
    "hero_kai": ["kai.png", "Kai.png"],
    "hero_nia": ["nia.png", "Nia.png"],
    "hero_bram": ["bram.png", "Bram.png"],
    "hero_luna": ["luna.png", "Luna.png"],
    "hero_zed": ["zed.png", "Zed.png"],
    ...
    "dungeonTiles": ["DungeonTiles.png"],
    "dungeonMonsters": ["DungeonMonsters.png"],
